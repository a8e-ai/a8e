...
impl Agent {
    ...
    async fn reply_internal(
        ...
        Ok(Box::pin(async_stream::try_stream! {
            let reply_stream_span = tracing::info_span!(target: "a8e::agents::agent", "reply_stream");
            ...
            if !last_assistant_text.is_empty() {
                tracing::info!(target: "a8e::agents::agent", trace_output = last_assistant_text.as_str());
            }
        }))
    }
